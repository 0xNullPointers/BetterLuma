...
BetterLumaCore is a maintained fork of LumaCore - the Steam client hook layer designed to handle family-sharing bypass, depot key injection, achievement spoofing, Denuvo authorization, legacy CD-key suppression, and seamless multiplayer proxying.
...
BetterLumaCore is distributed under the GNU General Public License v3 or later. See the root [LICENSE](LICENSE) file for the full text.
