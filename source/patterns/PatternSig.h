...
// table. The public key is hardcoded into betterluma so a hostile mirror
...
// or without sidecar .sig files and betterluma handles both.
//
...
#ifndef BETTERLUMA_PATTERN_SIG_H
#define BETTERLUMA_PATTERN_SIG_H
